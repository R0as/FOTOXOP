...
void gerenciaTeclado(unsigned char key, int mx, int my) {
    ...
    case'd':
    case'D':
        AVISO(Grafico: aplicando o desfoque na imagem.);
        _copiaDaImagem = copiaImagem(_imagem);
        desfoca(_imagem);
        _imagemFoiModificada = true;
        AVISO(Grafico: voltei da funcao desfoca.\n);
        opcoes();
        desenha();
        break;
    case 'r':
    case 'R':
        AVISO(Grafico: aplicando a funcao de relevo na imagem.);
        _copiaDaImagem = copiaImagem(_imagem);
        destaqueRelevo(_imagem);
        _imagemFoiModificada = true;
        AVISO(Grafico: voltei da funcao destaqueRelevo.\n);
        opcoes();
        desenha();
        break;
    ...
    case 'n':
    case 'N':
        AVISO(Grafico:aplicando o negativa na imagem.);
        _copiaDaImagem = copiaImagem(_imagem);
        negativa(_imagem);
        _imagemFoiModificada = true;
        AVISO(Grafico: voltei da funcao negativa.\n);
        opcoes();
        desenha();
        break;
    case 'm':
...
void opcoes() {
    printf("Escolha uma opção:\n"
           ...
           " 'd' para aplicar o desfoque\n"
           " 'n' para aplicar o filtro negativo.\n"
           " 'r' para aplicar o filtro de relevo.\n"
